  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <div className="text-sm pl-10 pt-4">If you don't have an account, <Link href='/register' className='text-blue-500 px-1'>SignUp</Link>  here</div>
...
const page = () => {
  return (
    ...
    <Link href='/' className="flex text-xl font-Poppins font-bold"> <FaArrowAltCircleLeft className="h-10 w-10"/><span className="pt-1 pl-3">Go Back Home</span> </Link> 
  <div className="flex items-center "><SignupFormDemo/></div>
  </div>
  )
}
