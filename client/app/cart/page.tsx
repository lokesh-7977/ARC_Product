      ...
      <MyContextProvider>
        ...
        <span className="pt-1 pl-3">Go Back Home</span>
              ...
              cart.items.map((item, index) => (
                <div key={index} className="bg-white mx-5 w-[15rem] h-[20rem] flex flex-col">
                  <div className="w-full h-[70%] relative">
                    <AiOutlineClose className="absolute  top-0 right-0 z-50 cursor-pointer p-1 h-7 w-7" onClick={() => handleDivCloseClick(index)} />
          ...
          <div className="justify-end ml-auto mr-5 bg-background border-[0.5px] border-secondary_color h-[20rem] my-32 w-[20rem]">
            ...
            <div className="text-2xl font-bold">Total: <span className="font-normal">{calculateTotal()} Rs</span></div>
            <hr className="w-52 my-2 border-2 border-secondary_color" />
            <div className="text-2xl font-bold">Subtotal: <span className="font-normal">{calculateSubtotal()} Rs</span></div>
            <hr className="w-52 my-2 border-2 border-secondary_color" />
            
            <div className="text-2xl font-bold">Delivery Fee: <span className="font-normal">{DELIVERY_FEE} Rs</span></div>
            <hr className="w-52 my-2 border-2 border-secondary_color" />
